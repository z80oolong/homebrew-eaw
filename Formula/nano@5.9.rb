...
+#endif
 			...
 			case '%':
 				SET(STATEFLAGS);
@@ -2059,6 +2107,21 @@ int main(int argc, char **argv)
 	if (getenv("TERM") == NULL)
 		setenv("TERM", "vt220", 0);
