...
index 64c4ea5c..aaa1adc1 100644
--- a/src/chars.c
+++ b/src/chars.c
@@ -28,6 +28,408 @@
 #include <wchar.h>
...
@@ -185,7 +587,11 @@ int mbwidth(const char *c)
...
index 4b9e9ea7..bdb8c28b 100644
--- a/src/winio.c
+++ b/src/winio.c
@@ -29,6 +29,9 @@
 #include <string.h>
...
+#endif /* NO_USE_UTF8CJK */
 ...
 #ifdef REVISION
@@ -1957,7 +1960,11 @@ char *display_string(const char *buf, size_t column, size_t span,
 		}
