...
index 64c4ea5c..e0877562 100644
--- a/src/chars.c
+++ b/src/chars.c
@@ -28,6 +28,391 @@
 #include <wchar.h>
...
@@ -185,7 +570,23 @@ int mbwidth(const char *c)
...
index 6c9a981c..02a6a3d6 100644
--- a/src/global.c
+++ b/src/global.c
...
index 86307021..3d50cec1 100644
--- a/src/nano.c
+++ b/src/nano.c
...
@@ -1827,6 +1835,14 @@ int main(int argc, char **argv)
...
+#endif
 ...
 #endif
 		{NULL, 0, NULL, 0}
@@ -1883,8 +1899,18 @@ int main(int argc, char **argv)
 	if (*(tail(argv[0])) == 'r')
 		SET(RESTRICTED);
...
+#endif /* NO_USE_UTF8CJK */
 ...
 #ifndef NANO_TINY
 			case 'A':
@@ -2114,6 +2140,19 @@ int main(int argc, char **argv)
 			case 'z':
 				SET(SUSPENDABLE);
 				break;
+#ifdef ENABLE_UTF8
...
+#endif
 			...
 			case '$':
 				SET(SOFTWRAP);
@@ -2125,6 +2164,21 @@ int main(int argc, char **argv)
 		}
 	}
...
index 9c53987a..4843f92c 100644
--- a/src/nano.h
+++ b/src/nano.h
@@ -535,6 +535,12 @@ enum
 	LET_THEM_ZAP,
...
index a69087e9..b0063826 100644
--- a/src/proto.h
+++ b/src/proto.h
...
index 722a65f2..eeaa532f 100644
--- a/src/rcfile.c
+++ b/src/rcfile.c
...
index 4b9e9ea7..2455bcbd 100644
--- a/src/winio.c
+++ b/src/winio.c
@@ -29,6 +29,12 @@
 #include <string.h>
...
+#endif
 ...
 int controlhome, controlend;
diff --git a/src/nano.c b/src/nano.c
index 86307021..b1a5e48f 100644
--- a/src/nano.c
+++ b/src/nano.c
@@ -667,6 +667,14 @@ void usage(void)
 	print_opt("-x", "--nohelp", N_("Don't show the two help lines"));
...
+#endif
 ...
 #endif
 		{NULL, 0, NULL, 0}
@@ -1862,7 +1878,16 @@ int main(int argc, char **argv)
 #endif
...
@@ -1883,8 +1908,18 @@ int main(int argc, char **argv)
 	if (*(tail(argv[0])) == 'r')
 		SET(RESTRICTED);
...
+#endif /* NO_USE_UTF8CJK */
 ...
 #ifndef NANO_TINY
 			case 'A':
@@ -2114,6 +2149,19 @@ int main(int argc, char **argv)
 			case 'z':
 				SET(SUSPENDABLE);
 				break;
+#ifdef ENABLE_UTF8
...
+#endif
 			...
 			case '$':
 				SET(SOFTWRAP);
@@ -2125,6 +2173,21 @@ int main(int argc, char **argv)
 		}
 	}
