class MuttAT2216 < Formula
  desc "Mongrel of mail user agents (part elm, pine, mush, mh, etc.)"
  homepage "http://www.mutt.org/"
  url "http://ftp.mutt.org/pub/mutt/mutt-2.2.16.tar.gz"
  mirror "https://github.com/muttmua/mutt/archive/refs/tags/mutt-2-2-16-rel.tar.gz"
  mirror "https://bitbucket.org/mutt/mutt/downloads/mutt-2.2.16.tar.gz"
