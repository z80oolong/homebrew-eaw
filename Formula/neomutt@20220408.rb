class NeomuttAT20220408 < Formula
  desc "E-mail reader with support for Notmuch, NNTP and much more"
  homepage "https://neomutt.org/"
  license "GPL-2.0-or-later"
  url "https://github.com/neomutt/neomutt/archive/20220408.tar.gz"
  sha256 "bb138adb09b1f164fe690749e991a5505bf4f50b6ad478ffb085c609d5617cc7"
...
@@ -175,7 +602,11 @@ int mutt_mb_width(const char *str, int col, bool display)
  */
...
index ed244b3..0dcbc47 100644
--- a/pager/display.c
+++ b/pager/display.c
@@ -858,7 +858,11 @@ static int format_line(struct MuttWindow *win, struct Line **lines, int line_num
       {
         space = ch;
       }
+#ifdef NO_USE_UTF8CJK
