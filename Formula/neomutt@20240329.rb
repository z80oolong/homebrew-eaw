class NeomuttAT20240329 < Formula
  desc "E-mail reader with support for Notmuch, NNTP and much more"
  homepage "https://neomutt.org/"
  license "GPL-2.0-or-later"
  url "https://github.com/neomutt/neomutt/archive/20240329.tar.gz"
...
index ebff47a..b196c04 100644
--- a/mutt_config.c
+++ b/mutt_config.c
@@ -568,6 +568,16 @@ static struct ConfigDef MainVars[] = {
...
index c76b149..59981fa 100644
--- a/pager/display.c
+++ b/pager/display.c
@@ -943,7 +943,11 @@ static int format_line(struct MuttWindow *win, struct Line **lines, int line_num
       {
         space = ch;
       }
+#ifdef NO_USE_UTF8CJK
