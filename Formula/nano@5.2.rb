...
@@ -1758,6 +1766,14 @@ int main(int argc, char **argv)
 		{"indicator", 0, NULL, 'q'},
 		{"unix", 0, NULL, 'u'},
 		{"afterends", 0, NULL, 'y'},
+#endif
...
@@ -1792,7 +1808,16 @@ int main(int argc, char **argv)
 #endif
...
@@ -1813,8 +1838,18 @@ int main(int argc, char **argv)
 	if (*(tail(argv[0])) == 'r')
 		SET(RESTRICTED);
...
+#endif /* NO_USE_UTF8CJK */
 ...
 #ifndef NANO_TINY
 			case 'A':
@@ -2048,12 +2083,40 @@ int main(int argc, char **argv)
 			case 'z':
 				SET(SUSPENDABLE);
 				break;
+#ifdef ENABLE_UTF8
...
+#endif /* NO_USE_UTF8CJK */
 ...
 #ifdef REVISION
@@ -1835,7 +1841,23 @@ char *display_string(const char *buf, size_t column, size_t span,
 		}
