...
index 2acbb90b0..bac7072fe 100644
--- a/mutt/mbyte.c
+++ b/mutt/mbyte.c
@@ -43,6 +43,430 @@
...
index 5a48634ce..a50be9b00 100644
--- a/pager/display.c
+++ b/pager/display.c
@@ -974,7 +974,11 @@ static int format_line(struct MuttWindow *win, struct Line **lines, int line_num
       {
         space = ch;
       }
+#ifdef NO_USE_UTF8CJK
