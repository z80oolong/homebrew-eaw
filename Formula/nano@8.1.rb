...
@@ -1839,6 +1847,14 @@ int main(int argc, char **argv)
 #ifdef HAVE_LIBMAGIC
 		{"magic", 0, NULL, '!'},
 #endif
+#ifdef ENABLE_UTF8
...
@@ -1869,7 +1885,16 @@ int main(int argc, char **argv)
 #endif
...
@@ -1880,8 +1905,18 @@ int main(int argc, char **argv)
 	if (*(tail(argv[0])) == 'r')
 		SET(RESTRICTED);
...
+#endif /* NO_USE_UTF8CJK */
 ...
 #ifndef NANO_TINY
 			case 'A':
@@ -2126,6 +2161,19 @@ int main(int argc, char **argv)
 				SET(USE_MAGIC);
 				break;
 #endif
+#ifdef ENABLE_UTF8
...
+#endif
 			...
 			case '@':
 				SET(COLON_PARSING);
@@ -2153,6 +2201,21 @@ int main(int argc, char **argv)
 	if (getenv("TERM") == NULL)
 		putenv("TERM=vt220");
