...
+#endif
 ...
 #endif
 		{NULL, 0, NULL, 0}
@@ -1885,8 +1901,18 @@ int main(int argc, char **argv)
 	if (*(tail(argv[0])) == 'r')
 		SET(RESTRICTED);
...
+#endif /* NO_USE_UTF8CJK */
 ...
 #ifndef NANO_TINY
 			case 'A':
@@ -2116,6 +2142,19 @@ int main(int argc, char **argv)
 			case 'z':
 				SET(SUSPENDABLE);
 				break;
+#ifdef ENABLE_UTF8
...
+#endif
 			...
 			case '$':
 				SET(SOFTWRAP);
@@ -2127,6 +2166,21 @@ int main(int argc, char **argv)
 		}
 	}
